...
public class LoginCtrl {
	...
	@RequestMapping(value="/deleteOneUserInverse",method=RequestMethod.POST)
	@ResponseBody
	public Map<String,Object> deleteOneUserInverse(HttpServletRequest request,Integer id){
		Map<String,Object> returnMap = new HashMap<String,Object>();

		try {
			Map<String,Object> map = userService.deleteOneUserInverse(id);
	...
	public Map<String,Object> getUserPageList(HttpServletRequest request,int currentPage,int pageSize,String blurUserName){
		...
		try {
			Page<User> userPage = userService.getUserPageList(currentPage,pageSize,blurUserName);
	...
	@ResponseBody
	public Map<String,Object> modifyPWD(HttpServletRequest request,Integer id,String passWord,String newPassWord){
		Map<String,Object> returnMap = new HashMap<String,Object>();

		try {
			Map<String,Object> map = loginService.modifyPWD(id,passWord,newPassWord);
			//获取user实体
			Object object = map.get("value");
			if(object != null){
				User user = (User) object;
