	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand"><span>Study</span>&nbsp;Evaluate</a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> User <span class="caret"></span></a>
						<ul class="dropdown-menu" role="menu">
							<li><a><span class="glyphicon glyphicon-user"></span> 个人信息</a></li>
							<li><a><span class="glyphicon glyphicon-cog"></span> 修改密码</a></li>
							<li><a><span class="glyphicon glyphicon-log-out"></span> 注销</a></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<form role="search">
			<div class="form-group">
				...
				<span>欢迎您！&nbsp;<span style="color: #00a2ca;">test</span>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;身份:&nbsp;<span <span style="color: #00a2ca;">学生</span></span>
			</div>
		</form>
		<ul class="nav menu">
			<!--学生-->
			<li><a><span class="glyphicon glyphicon-dashboard"></span> 我的课程</a></li>
			<li><a><span class="glyphicon glyphicon-th"></span> 评估教师</a></li>
			<li><a><span class="glyphicon glyphicon-th"></span> 评分教师</a></li>
			<li><a><span class="glyphicon glyphicon-stats"></span> 个人信息</a></li>
			<!--教师-->
			<li><a><span class="glyphicon glyphicon-list-alt"></span> 评估记录</a></li>
			<li><a><span class="glyphicon glyphicon-pencil"></span> 自我评估</a></li>
			<li><a><span class="glyphicon glyphicon-info-sign"></span> 个人信息</a></li>
			<!--领导-->
			<li><a><span class="glyphicon glyphicon-pencil"></span> 查看教师评估记录</a></li>
			<li><a><span class="glyphicon glyphicon-info-sign"></span> 个人信息</a></li>
			<!--管理员-->
			<li><a><span class="glyphicon glyphicon-pencil"></span> 评估管理</a></li>
			<li><a><span class="glyphicon glyphicon-info-sign"></span> 用户管理</a></li>
			<!--<li class="parent ">
				<a href="#">
